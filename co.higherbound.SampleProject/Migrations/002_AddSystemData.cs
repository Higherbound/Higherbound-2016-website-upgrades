...
" );
            ...
            RockMigrationHelper.UpdateBlockType( "Referral Agency Detail", "Displays the details of a Referral Agency.", "~/Plugins/co_higherbound/SampleProject/ReferralAgencyDetail.ascx", "co_higherbound > Sample Project", "2F130DF6-1EE4-45CE-9410-CBB0517EB33E" );
            RockMigrationHelper.UpdateBlockType( "Referral Agency List", "Lists all the Referral Agencies.", "~/Plugins/co_higherbound/SampleProject/ReferralAgencyList.ascx", "co_higherbound > Sample Project", "53F447CE-4B91-470A-A15D-B60DCAAB29CB" );
        ...
        {
            Sql( @"
    UPDATE [_co_higherbound_SampleProject_ReferralAgency] SET [AgencyTypeValueId] = NULL
" );

...
namespace RockWeb.Plugins.co_higherbound.SampleProject
{
    /// <summary>
    /// Displays the details of a Referral Agency.
    /// </summary>
    [DisplayName( "Referral Agency Detail" )]
    [Category( "co_higherbound > Sample Project" )]
    ...
    public partial class ReferralAgencyDetail : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            var definedType = DefinedTypeCache.Read( co.higherbound.SampleProject.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid() );
            if (definedType != null)
            {
